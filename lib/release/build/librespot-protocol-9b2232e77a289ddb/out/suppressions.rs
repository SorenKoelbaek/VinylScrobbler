...
//! Generated file from `suppressions.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_1;

// @@protoc_insertion_point(message:spotify.player.proto.Suppressions)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Suppressions {
    // message fields
    // @@protoc_insertion_point(field:spotify.player.proto.Suppressions.providers)
    pub providers: ::std::vec::Vec<::std::string::String>,
    // special fields
    // @@protoc_insertion_point(special_field:spotify.player.proto.Suppressions.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    s\x12\x1c\n\tproviders\x18\x01\x20\x03(\tR\tprovidersB\x02H\x02b\x06prot\
    o2\
";
